...
namespace Test2D;
public partial class EnemySpikeElite : Thing
{
	...
	public SpikeBackgroundElite Background { get; set; }
	...
	public override void Spawn()
	{
        ...
        {
			SpriteTexture = SpriteTexture.Atlas("textures/sprites/spike_top2_elite.png", 3, 3);
			AnimationPath = "textures/sprites/spike.frames";
			AnimationSpeed = 3f;

			Scale = new Vector2(Sandbox.Game.Random.Float(0f, 1f) < 0.5f ? -1f : 1f, 1f) * 2.4f;
			SpawnTime = 0f;
			Damage = 30f;
			Radius = 0.5f;
			BasePivotY = 0.5f;
    ...
    public override void ClientSpawn()
    {
		...
		Background = new SpikeBackgroundElite();
...
public partial class SpikeBackgroundElite : Sprite
{
	...
	public override void Spawn()
	{
		...
		Depth = -217f;
		Filter = SpriteFilter.Pixelated;
		Scale = new Vector2(Sandbox.Game.Random.Float(0f, 1f) < 0.5f ? -1f : 1f, 1f) * 2.6f;
	}
