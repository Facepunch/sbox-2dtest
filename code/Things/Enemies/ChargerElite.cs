...
public partial class ChargerElite : Enemy
{
    ...
    private const float CHARGE_TIME = 6f;
    ...
    public override void Spawn()
    {
        ...
        {
            SpriteTexture = SpriteTexture.Atlas("textures/sprites/charger_elite.png", 6, 6);
            AnimSpeed = 2f;
            BasePivotY = 0.08f;
            HeightZ = 0f;
    ...
    protected override void UpdatePosition(float dt)
    {
        ...
        if (!IsPreparingToCharge && !IsCharging && !IsAttacking && player_dist_sqr < 12f * 12f)
        {
    ...
    public void PrepareToCharge()
    {
        ...
        Game.PlaySfxNearby("enemy.roar.prepare", Position, pitch: Sandbox.Game.Random.Float(0.75f, 0.85f), volume: 0.9f, maxDist: 12f);
    ...
    public void Charge()
    {
        ...
        var target_pos = closestPlayer.Position + closestPlayer.Velocity * Sandbox.Game.Random.Float(0.5f, 2.45f);
